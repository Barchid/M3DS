...
void Revolution::initCube() {
    ...
    t = {
        1.0/3.0,0,              // s0 -> gauche     || 0
        0, 1.0/2.0,             // s0 -> devant     || 1
        0,0,                    // s0 -> bas        || 2
        2.0/3.0, 1.0/2.0,       // s1 -> haut       || 3
        0,1,                    // s1 -> devant     || 4
        1.0/3.0, 1.0/2.0,       // s1 -> gauche     || 5
        0, 1.0/2.0,             // s2 -> bas        || 6
        2.0/3.0,0,              // s2 -> gauche     || 7
        2.0/3.0, 0,             // s2 -> arriere    || 8
        2.0/3.0, 1.0/2.0,       // s3 -> arriere    || 9
        2.0/3.0,1,              // s3 -> haut       || 10
        2.0/3.0,1.0/2.0,        // s3 -> gauche     || 11
        1, 1.0/2.0,             // s4 -> arriere    || 12
        1,1,                    // s4 -> haut       || 13
        2.0/3.0, 1,             // s4 -> droite     || 14
        1,1.0/2.0,              // s5 -> haut       || 15
        1.0/3.0, 1,             // s5 -> droite     || 16
        1.0/3.0, 1,             // s5 -> devant     || 17
        2.0/3.0, 1.0/2.0,       // s6 -> droite     || 18
        1, 0,                   // s6 -> arriere    || 19
        1.0/3.0, 1.0/2.0,       // s6 -> bas        || 20
        1.0/3.0, 0,             // s7 -> bas        || 21
        1.0/3.0, 1.0/2.0,       // s7 -> droite     || 22
        1.0/3.0,1.0/2.0         // s7 -> devant     || 23
    };
